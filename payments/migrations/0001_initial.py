# Generated by Django 4.2 on 2023-12-02 13:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consume_code', models.PositiveIntegerField(db_index=True, null=True, verbose_name='consumed reference code')),
                ...
                ('package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s', to='subscriptions.package', verbose_name='packaage')),
